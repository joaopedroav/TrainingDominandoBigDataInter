EXPORT File_Lending := MODULE
    ...
    EXPORT MLLending := RECORD
        ...
        REAL acc_open_past_24mths;//Number of trades opened in past 24 months.
        REAL all_util;//Balance to credit limit on all trades
        REAL annual_inc;//LC assigned loan grade
        REAL delinq_2yrs;//The number of 30+ days past-due incidences of delinquency in the borrower's credit file for the past 2 years
        REAL avg_cur_bal;//Average current balance of all accounts
    END;
END;
